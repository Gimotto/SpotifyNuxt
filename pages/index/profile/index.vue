<template>
        <div align="center" class="contentstyle">     
           <svg color="white" width="80" height="90"><title>User Icon</title><path 
           ...
           <h2 style="color:white;" class="content">{{user.display_name}}</h2>
            <div class="content"><b-button class="btn-info" pill>Visualizza Account</b-button></div>
           <div class="content"><b-button class="btn-info" pill>Aiuto</b-button></div>
           <div class="content"><b-button class="btn-info" pill @click="logout()">Effettua Logout</b-button></div>
